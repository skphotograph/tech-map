...
チームによっては、本線をきれいに保つ目的で Squash and merge を標準にしていることがあります。
...
また、本線に残るのが 1 コミットになるため、作業中に分けておいたコミット単位の説明は本線側では見えなくなります。  
「きれいに見える」ことと「細かく追える」ことは、トレードオフです。

**仕組みが腹落ちしていないなら、無理に Squash and merge を選ばないでください。**  
チームに既定の取り込み方があるなら、それに従うのが安全です。  
